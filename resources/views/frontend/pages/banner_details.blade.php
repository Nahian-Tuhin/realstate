    ...
    <section class="about-us">
        <div class="container">
            <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
                ...
                <li class="ht-breadcrumbs__item"><a href="{{ route('banner.details', $bannerDetails->id) }}" target="blank" class="ht-breadcrumbs__link"><span
                            class="ht-breadcrumbs__title">{{ $bannerDetails->title }}</span></a></li>
                ...
                <div class="row">
                    <div class="col-md-12 col-md-main">
                        <div class="about-us__img">
                            <img src="{{ asset('uploads/banner/' . $bannerDetails->background_img) }}" alt="About us">
                        </div>
                        <!-- .about-us__img -->
                        <h1 class="about-us__title">{{ $bannerDetails->title }}</h1>
                        <p>
                            {{ $bannerDetails->text }}
                        </p>
                        </p>
