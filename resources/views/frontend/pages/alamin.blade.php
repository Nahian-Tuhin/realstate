...
<section class="about-us">
    <div class="container">
        <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
            ...
            <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Al Amin Corner Contracting</span></li>
        </ul>
        <!-- ht-breadcrumb -->
            ...
            <div class="row">
                <div class="col-md-8 col-md-main">
                    <div class="about-us__img">
                        <img src="{{ URL::asset('') }}images/uploads/Alamin-About.jpg" alt="About us">
                    </div>
                    <!-- .about-us__img -->
                    <h1 class="about-us__title">We are Al Amin Corner Contracting</h1>
                    <p>
                        <b>Al Amin Corner Contracting</b> is  operating  in  the  UAE    and
