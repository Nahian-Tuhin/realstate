            ...
            <div class="jumbotron">
                <form action="{{ route('searchProperty') }}" class="form-inline search-form" method="get">
                    ...
                    <div class="form-group">
                        ...
                        {{-- <select class="ht-field listing-sort__field" id="filter_price">
                            <option value="">Prices</option>

                            <option data-from="100000" data-to="150000" value="">100000 - 150000</option>
                            <option data-from="150000" data-to="200000" value="">150000 - 200000</option>
                            <option data-from="200000" data-to="250000" value="">200000 - 250000</option>
                        </select> --}}
