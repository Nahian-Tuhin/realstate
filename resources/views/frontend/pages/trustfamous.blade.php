...
<section class="about-us">
    <div class="container">
        <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
            ...
            <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Trust Famous Real Estate</span></li>
        </ul>
        <!-- ht-breadcrumb -->
            ...
            <div class="row">
                <div class="col-md-8 col-md-main">
                    <div class="about-us__img">
                        <img src="{{ URL::asset('') }}images/uploads/Real-Estate-about.jpg" alt="About us">
                    </div>
                    <!-- .about-us__img -->
                    <h1 class="about-us__title">We are Trust Famous Real Estate </h1>
                    <p>
                        <b>Trust Famous Real Estate </b>is  operating  in  the  UAE    and
specifically in Abu Dhabi since the last 20 years. We  provide services in the Real Estate sector as  an installation Sub-Contractor for major projects. We  have been associated with the largest MEP  Contractors in the business and have undertaken  complex installation on some of the major projects in  the country.
