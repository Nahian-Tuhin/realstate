            ...
            <div class="row">
                <div class="col-md-8 col-md-main">
                    <div class="about-us__img">
                        <img src="{{ URL::asset('') }}images/uploads/ibrahimAlSaffar-About.jpg" alt="About us">
                    </div>
                    <!-- .about-us__img -->
                    <h1 class="about-us__title">We are IBAS Group</h1>
                    <p>
                        <b>Ibrahim  Al  Saffar </b>is  operating  in  the  UAE    and
                    ...
                    <p>
                     ...
                     <h1 class="about-us__title">OUR VISION</h1>
                    <p>To  make the dreams cum true of architects, developers  and mep consultants by  providing efficient mep installation and testing services and to become no.1 mep sub contractor.
                    </p>
                                        <h1 class="about-us__title">OUR MISSION</h1>
                                        <p>To establish cohesive working environment between our client and IBAS team so that
                    We can deliver as per clients requirements in time.

                    </p>
                                        <h1 class="about-us__title">OUR QUALITY POLICY</h1>
                                        <p>To Train IBAS Team As Per Latest International Standards And Techniques So That Their Hard Work Is Used For Productive Work<br /><br />
                                            To ensure that our workers follow international safety standards and save life and property<br /><br />
                                            To positively contribute in UAE National Development
                    </p>
                        </div>
                <!-- .col -->
