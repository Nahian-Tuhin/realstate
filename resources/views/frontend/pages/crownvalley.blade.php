...
@section('title')
Crown Valley Genral Contracting
@endsection
@section('content')
...
<section class="about-us">
    <div class="container">
        <ul class="ht-breadcrumbs ht-breadcrumbs--y-padding ht-breadcrumbs--b-border">
            ...
            <li class="ht-breadcrumbs__item"><span class="ht-breadcrumbs__page">Crown Valley Genral Contracting</span></li>
        </ul>
        <!-- ht-breadcrumb -->
            ...
            <div class="row">
                <div class="col-md-8 col-md-main">
                    <div class="about-us__img">
                        <img src="{{ URL::asset('') }}images/uploads/crown-About.jpg" alt="About us">
                    </div>
                    <!-- .about-us__img -->
                    <h1 class="about-us__title">We are Crown Valley Genral Contracting</h1>
                    <p>
                        <b>Crown Valley Genral Contracting </b> is  operating  in  the  UAE    and
