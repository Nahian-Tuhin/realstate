                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="30%">
                                            ...
                                            <img style="width: 60px;" src="{{ asset('uploads/banner') }}/{{ $banner->banner_image }}" alt="{{ $banner->title }}">
                                          
                                            @else
                                            <img style="width: 60px; border: 3px solid red" src="{{ url('banner/no_image.png') }}" alt="No Image">
                                            @endif
                                        </td>
                                        <td>
                                            @if (!empty($banner['background_img']))
                                            {{-- <img style="width: 60px;" src="{{ asset('public/uploads/banner/'.$banner['background_img']) }}"> --}}
                                            <img style="width: 60px;" src="{{ URL::asset('/uploads/banner/'.$banner->background_img) }}" alt="{{ $banner->title }}">
