                                ...
                                {{-- <div class="form-row"> --}}
                                    ...
                                    <div class="form-group col-md-6 mt-4">
                                        <div class="custom-file">
                                            ...
                                            <input type="file" class="" id="customFile" name="banner_image" accept="image/*">
                                        </div>
                                    </div>

                                    <div class="form-group col-md-6 mt-4">
                                        <div class="custom-file">
                                            <label class="file-label" for="customFile">Choose Background</label>
                                            <input type="file" class="file-input" id="customFile" name="background_img" accept="image/*">
                                        </div>
                                    </div>

                                    <div class="form-group col-md-6 mt-4">
                                                <label>Description</label>
                                                <textarea  name="text" row='10' placeholder="Optional" class="form-control"> {{ old('text', $banner_data['text']) }}</textarea>
                                        </div>
                                    {{-- </div> --}}
                                    ...
                                    <div class="form-group col-md-6 mt-4">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <input type="text" class="form-control" id="validationCustomUsername" name="link" value="{{ old('link', $banner_data['link']) }}" placeholder="about" aria-describedby="inputGroupPrepend">
