                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('mep-services.create') }}" class="btn btn-success float-right">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i>Add {{  Str::singular($title)}}</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">
                                            ...
                                            <img style="width: 60px;" src="{{ URL::asset('/uploads/mep/'.$update->image) }}" alt="{{ $update->title }}">
                                            @else
                                        ...
                                        <td width="20%">
                                            ...
                                            <td>
                                             ...
                                             Footer Top
                                                ...
                                                @elseif ($update->position == 2)
                                               Footer Middle

                                                @elseif ($update->position == 3)
                                                Footer Last
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-sm" href="{{ route('mep-services.edit', $update->id) }}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <form style="display: inline-block" action="{{ route('mep-services.destroy', $update->id) }}" class="form-delete" method="post">
                                                @csrf
                                                @method('DELETE')
